...
class ProcessController < ApplicationController
  def execute
    respond_to do |format|
      ...
      DownloadOrganization::DownloadManager.process_result( search_result, movies_dir, shows_dir, DownloadOrganizer::Application.config.overwrite_files, DownloadOrganizer::Application.config.delete_files )
    end
    true
  end
end
